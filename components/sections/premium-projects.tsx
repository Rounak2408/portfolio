...
const featured = [
  {
    title: "HireSense AI",
    impact: "JD-based matching that speeds up screening and shortlist decisions.",
    description:
      "Recruiter-first resume intelligence: candidate matching, shortlist/hold/reject decisions, ATS-style diagnostics, and hiring analytics with a clean, panel-ready UX.",
    stack: ["Python", "Streamlit", "spaCy", "PostgreSQL", "SQLAlchemy", "NLP parsing", "pandas/Plotly"],
    live: "https://hiresense-ai-3teg.onrender.com/",
    code: "https://github.com/Rounak2408/HireSense-AI",
    // Use locally-copied screenshot asset for the featured case study.
    image: "/hiresense-dashboard.png",
  },
  {
    title: "QuizForge AI",
...
const others = [
  {
    ...
    type: "Web Dev",
    description:
      "AI-powered repository intelligence for originality, quality, security, and viva/interview readiness with shareable reports.",
    stack: ["Next.js", "TypeScript", "Tailwind CSS", "Prisma", "PostgreSQL", "Auth.js"],
    period: "2026",
    team: "Team: 1",
    rating: 4,
    live: "https://code-viva-ai.vercel.app/",
    code: "https://github.com/Rounak2408/CodeViva-AI",
  },
  {
    title: "DevFlow AI",
    type: "Web Dev",
    description:
      "Production-ready AI workspace inspired by Linear + Notion + Jira with MERN stack, Kanban, realtime chat, analytics, and automation.",
    stack: ["React", "Node.js", "MongoDB", "Redis", "Socket.io", "Bull queues", "OpenAI"],
    period: "2026",
    team: "Team: 1",
    rating: 3,
    live: "https://dev-flow-ai-flax.vercel.app/",
    code: "https://github.com/Rounak2408/DevFlow-AI",
  },
